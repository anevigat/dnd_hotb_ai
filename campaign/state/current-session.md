...
|---|---|---|---|---|
| Lupin (Guerrero elfo) | 1/12 | — | arco corto, cota de malla, espadón, farol, ~4 po | Sendero (tras despertar de la emboscada de Pral) |
| Maguín (Mago humano) | 1/7 | — | libro de conjuros, ~59 po | Sendero (tras despertar de la emboscada de Pral) |
| Chancla (Clériga enana) | 1/9 | — | camisa de malla, maza, ~59 po — 1 ficha de poder gastada de 2 (se recupera con descanso) | Sendero (tras despertar de la emboscada de Pral) |

## Iniciativa / turno actual

_(Solo relevante durante combate: orden de turno y quién va ahora.)_
